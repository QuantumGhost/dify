...
from services.human_input_im.logging_provider import LoggingHumanInputIMProvider
...
class HumanInputIMProviderRegistry:
    ...
    def __init__(self, providers: dict[IMProvider, HumanInputIMProvider] | None = None) -> None:
        self._providers = providers or {IMProvider.FEISHU: LoggingHumanInputIMProvider()}
