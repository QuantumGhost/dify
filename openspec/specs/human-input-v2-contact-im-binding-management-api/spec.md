# human-input-v2-contact-im-binding-management-api Specification

## Purpose
Define provider-agnostic contact APIs and eligibility rules for managing synchronized IM identities, contact bindings, and workspace overrides through the existing effective-binding model.
