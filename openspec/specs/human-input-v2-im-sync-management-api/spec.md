# human-input-v2-im-sync-management-api Specification

## Purpose
Define provider-agnostic workspace APIs and orchestration contracts for configuring IM integrations, running manual directory synchronization, and exposing canonical sync results safely.
...
#### Scenario: Read current IM integration
...
#### Scenario: Update existing IM integration
...
#### Scenario: Trigger one manual sync
